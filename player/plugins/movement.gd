...
var footstep_scene = preload("res://player/footstep_sound/FootstepSound.tscn").instance()
...
func set_player(new_player):
	...
	landTween = player.get_node_or_null("LandTween")

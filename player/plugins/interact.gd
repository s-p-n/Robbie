...
var PowerLineScene = preload("res://scenes/PowerLine/PowerLine.tscn")

var player:KinematicBody
var interactable_notice:Sprite
var pickup_ray:RayCast
var wire_ray:RayCast
var clip_ray:RayCast
var wire_reel_audio:AudioStreamPlayer
var placement_audio:AudioStreamPlayer
...
func set_player(new_player):
	player = new_player
	pickup_ray = player.get_node_or_null("Head/PickupRay")
	wire_ray = player.get_node_or_null("Head/WireRay")
	clip_ray = player.get_node_or_null("Head/ClipRay")
	interactable_notice = player.get_node_or_null("Head/CenterDot/Interactable")
	wire_reel_audio = player.get_node_or_null("Sounds/WireReelAudio")
	placement_audio = player.get_node_or_null("Sounds/PlacementAudio")
	clip_wire_audio = player.get_node_or_null("Sounds/WireCutAudio")
	interactable_notice.visible = false
	hold_position = player.get_node_or_null("Head/HoldPosition")
